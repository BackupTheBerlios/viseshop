...
CREATE DATABASE IF NOT EXISTS vislabshop;
USE vislabshop;

--
-- Definition of table `vislabshop`.`account`
--

DROP TABLE IF EXISTS `vislabshop`.`account`;
CREATE TABLE  `vislabshop`.`account` (
...
INSERT INTO `vislabshop`.`account` VALUES  ('av2@freenet.de','','','','',0,'passwort','Andreas','V'),
...
--
-- Definition of table `vislabshop`.`commoditygroup`
--

DROP TABLE IF EXISTS `vislabshop`.`commoditygroup`;
CREATE TABLE  `vislabshop`.`commoditygroup` (
...
INSERT INTO `vislabshop`.`commoditygroup` VALUES  (1,'Tinten, Toner, Farbbänder','Hier finden Sie Tinten, Toner und Farbbänder passend für ihren Drucker oder ihr Faxgerät.',NULL),
...
--
-- Definition of table `vislabshop`.`item`
--

DROP TABLE IF EXISTS `vislabshop`.`item`;
CREATE TABLE  `vislabshop`.`item` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
INSERT INTO `vislabshop`.`item` VALUES  (1,'5-Star BCI-3BK schwarz',100,10,'Hersteller:  	5*\r\nFarbe: 	schwarz\r\nAusführung: 	Canon BJC 6000 / BJC 6100\r\nGewicht: 	BCI-3BK\r\nInhalt: 	31 ml\r\nLiefereinheit: 	1 Stück\r\nBJC-3000\r\nBJC-6000\r\nS 400\r\nS 450',4,4.42),
 ...
 (5,'Canon 4479A002 Patrone InkJet BCI-3E Bk schwarz',20,5,'Hersteller:  	Canon\r\nHersteller Nr.: 	BCI-3EBk\r\nFarbe: 	schwarz\r\nLiefereinheit: 	1 Stück',4,12.46),
 (6,'Canon 4480A002 Patrone InkJet BCI-3C BJC 6000 cyan',20,5,'Hersteller:  	Canon\r\nHersteller Nr.: 	BCI-3C\r\nFarbe: 	cyan\r\nLiefereinheit: 	1 Stück\r\nBJC 6000',4,9.91);
INSERT INTO `vislabshop`.`item` VALUES  (7,'Canon 4481A002 Patrone InkJet BCI-3M BJC 6000 magenta',20,5,'Hersteller:  	Canon\r\nHersteller Nr.: 	BCI-3M\r\nFarbe: 	magenta\r\nLiefereinheit: 	1 Stück\r\nBJC 6000',4,9.91),
 (8,'Canon 4482A002 Patrone InkJet BCI-3Y BJC 6000 gelb',20,5,'Hersteller:  	Canon\r\nHersteller Nr.: 	BCI-3Y\r\nFarbe: 	gelb\r\nLiefereinheit: 	1 Stück',4,9.91),
 (9,'Canon Druckkopf InkJet BC-30E BJC 6000 schwarz ca. 5.000 Seiten',10,2,'Hersteller:  	Canon\r\nHersteller Nr.: 	BC-30\r\nFarbe: 	schwarz\r\nLiefereinheit: 	1 Stück\r\nBJC 6000.\r\n4608A002\r\nBC30E',4,39.85),
 (10,'Hewlett-Packard Patrone InkJet Nr.15 schwarz 25ml C6615DE',100,10,'Hersteller:  	Hewlett-Packard\r\nHersteller Nr.: 	C6615DE\r\nFarbe: 	schwarz\r\nAusführung: 	25ml\r\nLiefereinheit: 	1 Stück\r\nDeskJet 840 C',2,26.99),
 (11,'Hewlett-Packard Tintenpatrone InkJet Nr.78 farbig 19ml C6578DE',60,8,'Hersteller:  	Hewlett-Packard\r\nHersteller Nr.: 	C6578DE\r\nFarbe: 	farbig cyan magenta gelb\r\nInhalt: 	19ml\r\nLiefereinheit: 	1 Stück\r\nHP Nr. 78 Dreikammer-Farbdruckpatrone (C/M/Y) Nr. 78 (19 ml)\r\nfür HP DeskJet 930C/940C/950C/970Cxi/1220C, OfficeJet G55/G85/G95/K60/K80',2,31.36),
 (12,'Hewlett-Packard SA310AE Tinten-Kombi-Pack Nr.15 + Nr.78',30,5,'Hersteller:  	Hewlett-Packard\r\nHersteller Nr.: 	SA310AE\r\nFarbe: 	schwarz + CMY\r\nInhalt: 	25ml + 19ml\r\nLiefereinheit: 	1 Packung\r\nDruckkosten sparen im Doppelpack: Je einmal die schwarze HP Patrone Nr.15 (C6615DE) und die Farbpatrone HP Nr.78 (C6578DE).',2,53.84);
INSERT INTO `vislabshop`.`item` VALUES  (13,'Brother Tonerset TN11 C/M/Y für HL-4000CN',10,3,'Hersteller:  	Brother\r\nHersteller Nr.: 	TN11\r\nFarbe: 	Cyan, Magenta, Yellow\r\nLiefereinheit: 	3 Toner\r\nTN-11 Toner Set.\r\n\r\nBestehend aus je einer Tonerkartusche cyan, magenta und gelb.\r\n\r\nDruckkapazität pro Toner ca. 6.000 Seiten bei 5% Deckung.',3,451.24),
 (14,'Brother Toner für HL-4000CN TN-11BK schwarz',20,10,'Hersteller:  	Brother\r\nHersteller Nr.: 	TN11BK\r\nFarbe: 	schwarz\r\nAusführung: 	Brother\r\nInhalt: 	ca. 8500 Seiten bei\r\nLiefereinheit: 	1 Stück\r\nTN-11BK Toner Schwarz für HL-4000CN. Druckkapazität ca. 8.500 Seiten.',3,64.38),
 (15,'Multifunktionspapier Presentation',100,40,'DIN A4, weiß, 100g, 250 Blatt',6,4.59),
 (16,'Multifunktionspapier Universal A3',30,10,'DIN A3, weiß, 80g, 500 Blatt',6,14.46),
 (17,'Multifunktionspapier Universal A4',300,100,'DIN A4, weiß, 80g, 500 Blatt',6,7.23),
 (18,'Clairfontaine A4 kirschrot',30,10,'DIN A4, kirschrot, 120g, 250 Blatt',7,8.26),
 (19,'Clairfontaine A4 fuchsia',30,10,'DIN A4, fuchsia, 120g, 250 Blatt',7,8.26);
INSERT INTO `vislabshop`.`item` VALUES  (20,'Clairfontaine A4 sonnengelb',30,10,'DIN A4, sonnengelb, 120g, 250 Blatt',7,8.26),
 (21,'3M Kopierfolie DIN A4',10,5,'3M Kopierfolie DIN A4, mit Sensorfilter, 100 Blatt 002280',9,35.55),
 (22,'3M InkJet Folie HP-Modelle',20,10,'3M InkJet Folie HP-Modelle, DIN A4, abziehbarer Sensorstreifen, 50 Stück 3460-50',8,45.88);
UNLOCK TABLES;
/*!40000 ALTER TABLE `item` ENABLE KEYS */;


--
-- Definition of table `vislabshop`.`order`
--

DROP TABLE IF EXISTS `vislabshop`.`order`;
CREATE TABLE  `vislabshop`.`order` (
